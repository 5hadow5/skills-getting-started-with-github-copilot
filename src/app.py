...
activities = {
    ...
    "Soccer Club": {
        "description": "Recreational soccer practice and matches",
    ...
    "Debate Team": {
        "description": "Prepare for debates and inter-school competitions",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 20,
        "participants": ["emma@mergington.edu", "daniel@mergington.edu"]
    }
}
